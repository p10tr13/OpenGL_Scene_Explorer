...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(800, 600, "GK Project 4", NULL, NULL);
	if (window == NULL)
	{
	...
	// Vertex shader compilation (zamienia jedne wspó³rzêdne na drugie w NDC)
	...
	// Fragment shader compilation (koloruje)
